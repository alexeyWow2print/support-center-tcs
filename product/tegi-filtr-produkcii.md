...
Теги можно [отображать на тизере продукта](./tegi-filtr-produkcii#добавление-тегов-в-продукт) (правый верхний угол), чтобы сразу показать клиенту ключевую информацию. Например, наличие скидки на продукт или выгодной цены (Хит продаж, Скидка):
...
В категории продуктов можно отобразить [полноценный фильтр](./tegi-filtr-produkcii#фильтр-продукции), который реализуется с помощью системы тегов (Продукт, Тираж, Тип печати, Дополнительно). С помощью фильтров клиент сможет сортировать продукцию по заданным условиям:
...
![](./tegi-filtr-produkcii-8.png){width=927px height=414px}



Чтобы создать тег, необходимо нажать на «Добавить тег», откроется следующее окно с настройками:

![](./tegi-filtr-produkcii-9.png){width=868px height=253px}
...
![](./tegi-filtr-produkcii-10.png){width=762px height=415px}
...
![](./tegi-filtr-produkcii-11.png){width=762px height=411px}
...
![](./tegi-filtr-produkcii-12.png){width=863px height=284px}
