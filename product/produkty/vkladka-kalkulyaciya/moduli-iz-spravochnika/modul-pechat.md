---
description: >-
  Модуль «Печать» позволяет добавить в расчет стоимости операцию печати
  (цифровую, офсетную и т.д.), а также настроить выбор материалов, количества
  сторон и (для рулонной продукции) параметры намотки.
order: 1.6
---
...
* Для добавления печатной машины нажмите кнопку **«Добавить»**. Выберите существующую операцию из списка или создайте новую. (см. статью [Операция печать](../../../../handbook/operacii/pechat.md)).
...
* **Настройка** — переход к детальной настройке параметров выбранной печати. (см. статью [Операция печать](../../../../handbook/operacii/pechat.md#operaciya-pechat))
...
Нажмите **«Добавить»**, чтобы подключить доступные варианты сторон. Доступный для подключения набор определяется [в настройках печатного оборудования](../../../../handbook/operacii/pechat.md#vkladka-cvetnost-i-storony-pechati), добавленного на первой вкладке.
