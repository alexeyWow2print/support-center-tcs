...
-  Для добавления каширования нажмите кнопку **«Добавить»**. Выберите существующую операцию из списка или создайте новую. (см. статью [Каширование](./../../../../spravochnik/dop-operacii/kashirovanie)).
...
-  **Настройка** -- переход к детальной настройке параметров выбранной операции. (см. статью [Каширование](./../../../../spravochnik/dop-operacii/kashirovanie)
