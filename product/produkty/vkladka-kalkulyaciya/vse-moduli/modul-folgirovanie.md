...
-  Для добавления фольгирования нажмите кнопку **«Добавить»**. Выберите существующую операцию из списка или создайте новую. (см. статью [Фольгирование](./../../../../spravochnik/dop-operacii/folgirovanie)).
...
-  **Настройка** -- переход к детальной настройке параметров выбранной печати. (см. статью [Фольгирование](./../../../../spravochnik/dop-operacii/folgirovanie))
