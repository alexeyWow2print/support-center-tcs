...
Модуль «Печать» позволяет добавить в расчет стоимости операцию печати (цифровую, офсетную и т.д.), а также настроить выбор материалов, количества сторон и (для рулонной продукции) параметры намотки.
...
|-----------------------|------------------------------------|
| **Операция «Печать»** | Всегда                             |
| **Материал «Бумага»** | Кроме деталей с расчетом в штуках  |
| **Количество сторон** | Всегда                             |
| **Намотка**           | Только для деталей с расчетом в м² |
...
-  **Показывать группировки на сайте** -- если у вас есть группировки операций, этот переключатель позволит отобразить их для выбора клиенту. При включении появляются два поля:
   ...
   -  **Отображение** -- формат показа группировок (список, радио батон, иконки и т.д.).
...
-  Для добавления печатной машины нажмите кнопку **«Добавить»**. Выберите существующую операцию из списка или создайте новую. (см. статью [Операция печать](./../../../../spravochnik/operacii/pechat)).
...
-  **Настройка** -- переход к детальной настройке параметров выбранной печати. (см. статью [Операция печать](./../../../../spravochnik/operacii/pechat))
...
-  **Отображать цвет на сайте** -- если у материалов[ настроены цвета](./../../../../spravochnik/svoistva/_index), клиент сможет выбрать нужный. При активации появляются:
...
-  Для добавления материалов нажмите **«Добавить»** и выберите нужный материал из справочника или создайте новый (см. статью «[Операция Печать](./../../../../spravochnik/operacii/pechat)»).
...
-  **Толщина / Плотность** -- список значений (например, 100, 148, 300 грамм), которые есть у данного материала. Чтобы значение было доступно клиенту для выбора, нужно установить напротив него галочку. Список этих параметров задается в [настройках самого материала.](./../../../../spravochnik/materialy/bumaga/sozdanie-materiala)
...
Нажмите **«Добавить»**, чтобы подключить доступные варианты сторон. Доступный для подключения набор определяется [в настройках печатного оборудования](./../../../../spravochnik/operacii/pechat#операция-печать), добавленного на первой вкладке.
