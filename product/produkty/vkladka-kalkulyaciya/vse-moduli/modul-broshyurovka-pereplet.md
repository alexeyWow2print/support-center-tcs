...
1. В правом нижнем углу экрана нажмите кнопку **«+»**.
...
-  **Показывать на сайте** -- главный переключатель. Если он активен, блок Брошюровки будет виден в карточке товара.
   ...
   -  **Отображение** -- выбор внешнего вида опций на сайте: выпадающий список, радио баттон, иконки, плитка и радио баттон с иконкой.
...
-  **Кнопка «Удалить»** (значок корзины) -- предназначена для полного удаления модуля «Брошюровка / переплёт» вместе со всеми добавленными операциями из калькуляции продукта.
