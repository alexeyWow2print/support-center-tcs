...
К каждому продукту можно назначить один или несколько тегов. С помощью тегов можно визуально выделить продукт или вовсе создать фильтр внутри категории продуктов. Более подробно можно узнать из статьи в справке [Теги](./../tegi-filtr-produkcii)
