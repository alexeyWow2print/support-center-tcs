...
В данном разделе группируется, создается, редактируется и удаляется вся продукция (в т.ч. [калькуляция продукции](./../product/produkty/vkladka-kalkulyaciya/dopolnitelnye-knopki/proverka-kalkulyacii)), как отображаемая на сайте, так и находящаяся в процессе создания калькуляции.
...
В подразделе [Виджеты](./../content/vidzhety/_index) вы можете создать следующие виджеты: [Таймер](./../content/vidzhety/vidzhet-taimer), [Рекомендуемые продукты](./../content/vidzhety/vidzhet-rekomenduemaya-produkciya), [Галерея](./../content/napolnenie-sayta/galerei), [Каталог товаров](./../content/vidzhety/vidzhet-katalog-tovarov), [Новости/Блог](./../content/vidzhety/vidzhet-novosti-blog). Подраздел [SEO](./../content/seo/_index) содержит инструменты для продвижения сайта: 301 редирект, Канонические ссылки, Карта сайта Sitemap, Файл robots.txt, Мета-тэги.



### [Справочник](./../spravochnik/_index)
