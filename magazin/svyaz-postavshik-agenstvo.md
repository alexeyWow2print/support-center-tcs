...
После того как заказ попадает в общий список заказов Поставщика, Агентство может скачать счет на оплату в [Счета поставщиков (кредит) для агентств](./bukhgalteriya/scheta-postavshikov).
