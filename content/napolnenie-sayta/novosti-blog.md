...
Здесь можно [создать ](./novosti-blog#статьи)новую статью, изменить существующую и увидеть общую информацию по всем размещенным статьям в данном блоке новостей.
...
Список виджетов данного блока новостей. При нажатии на кнопку «Создать виджет», откроется стандартное окно создания виджета. Подробнее о виджете Новости / блог [здесь](./../vidzhety/vidzhet-novosti-blog).
