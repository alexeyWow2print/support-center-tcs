...
-  **Страницы продукции** Находятся в разделе [Продукция](./../../../product/_index), в контенте таких страниц имеется предустановленный элемент -- калькуляция продукта, по этой причине контент страницы поделен на 3 части:
...
-  **Посадочные страницы** Находятся в подразделе [Шаблоны](./shablony), по функционалу очень схожи со стандартными страницами, полностью редактируются, но создаются на основе шаблона.
...
-  **Canonical link**
   ...
   Применяется с целью предотвращения дублей контента. Благодаря этому, поисковые боты воспринимают страницу с canonical как приоритетную для поисковой выдачи; ([Подробнее](./../../seo/_index))

-  **noindex, nofollow**

   Нужны для управления репутацией сайта в поисковых системах; ([Подробнее](./../../seo/_index)) noindex - запрещает поисковым роботам индексировать страницу; nofollow - запрещает поисковым роботам переходить по ссылкам на странице;