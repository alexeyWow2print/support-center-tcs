...
-  **Блог**
   ...
   В разделе [Новости](./../napolnenie-sayta/novosti-blog) можно создавать отдельные разделы новостей со своими url.\
...
![](./vidzhet-novosti-blog.gif){width=924px height=384px}
...
![](./vidzhet-novosti-blog-2.gif){width=1426px height=754px}