...
Чтобы создать виджет «Таймер», в админ-панели сайта войдите в раздел «_Контент → Виджеты»_, нажмите на кнопку «Добавить» в правом верхнем углу. В открывшемся окне найдите виджет «Тайме&#x440;_»_ и нажмите «Создать».
...
* **Название** виджета\
  Внутреннее название для админ-панели.<br>
* **Тип устройства**
...
* **Текст блока**\
  Добавляет над виджетом заголовок H2.<br>
*   **Текст таймера**

    Добавляет в виджете над таймером заголовок H3.<br>
* **Время работы таймера (мес)**\
  Имеется возможность указать время работы таймера в месяцах. 1 месяц = 30 дней.<br>
...
* **Время начала**\
  С помощью этого поля можно задать точку отсчета таймера: год, месяц, день, часы и минуты.<br>
* **Цвет фона**\
