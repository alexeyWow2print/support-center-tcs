...
При поступлении нового обращения с сайта, ответственный менеджер получит уведомление. Если у клиента нет ответственного менеджера, то уведомление придет на почту типографии, указанную в [контактных данных](https://support.wow2print.com/nastroiki/drugie-nastroiki/kontaktnye-dannye).
