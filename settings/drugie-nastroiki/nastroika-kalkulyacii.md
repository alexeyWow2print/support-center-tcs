...
2. **Для обычных товаров**
   ...
   -  Кнопка отображается всегда в карточке товара. Исключение, если в настройках товара отключена [обязательная загрузка макета](./../../product/produkty/vkladka-obschie). Предназначена для загрузки готового макета.
...
В этом разделе вы можете загрузить общую инструкцию, которая будет автоматически отображаться для всех товаров на сайте. Но если у продукта во вкладке "Общие" загружена [индивидуальная инструкция](./../../product/produkty/vkladka-obschie#загрузить-инструкцию), то отображаться на сайте будет именно она, а не универсальная.
