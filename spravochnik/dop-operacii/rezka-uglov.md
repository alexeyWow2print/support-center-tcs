...
Чтобы удалить изображение нажмите кнопку ![](./rezka-uglov.png){width=131px height=40px} напротив загруженного изображения.
...
В случае, если у вас установлен модуль ["Мультивалютность"](./../../settings/oplata/multivalyutnost), вы можете настроить разную валюту для операции Резка углов.
...
Для удобства операцию Резка углов можно копировать. Нажмите на кнопку "Копировать" напротив нужной операции -> подтвердите действие, нажав Копировать ![](./rezka-uglov-2.png){width=160px height=40px}
