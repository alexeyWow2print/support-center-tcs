...
Чтобы удалить изображение нажмите кнопку "Удалить" ( ![](./loson-aromatizator.png){width=131px height=40px} ) напротив загруженного изображения. ​
...
Чтобы внести цены на лосьон/ароматизатор, щелкните мышкой на выбранные *свойства*.
...
В случае, если у вас установлен модуль ["Мультивалютность"](./../../settings/oplata/multivalyutnost), вы можете настроить разную валюту для комплектующего Лосьон/ароматизатор.
...
Чтобы отредактировать данные, зайдите в нужный Лосьон/ароматизатор, щёлкнув мышкой на *название*.
