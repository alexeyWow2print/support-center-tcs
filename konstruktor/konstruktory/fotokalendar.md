...
* _Тип конструктора_ — выбираем "Фотокалендарь";
* _Ширина (мм)_ — ширина фотокалендаря;
* _Высота (мм)_ — высота фотокалендаря;
* _Безопасная область (мм)_ — безопасная область макета фотокалендаря;
* _Вылеты под обрез (мм)_ — вылеты под обрез макета фотокалендаря;
* [_Тип продукта_](fotokalendar.md#tip-produkta) — Календарь-домик, Стандарт или С навивкой посередине.
...
* _Календарь-домик_ — в верхней части страницы и обложки показана навивка;

![Тип продукта Календарь-домик](<../../.gitbook/assets/image (1978).png>)

* _Стандарт_ — в верхней части страницы и обложки показана навивка;

![Тип продукта Стандарт](<../../.gitbook/assets/image (2878).png>)

* _С навивкой посередине_ — в середине страницы и обложки показана навивка.
...
* Создать новый - "[Добавить](fotokalendar.md#sozdanie-novogo-shablona)";
* Импортировать из другого конструктора - "[Импорт](fotokalendar.md#import-shablonov)".
...
* _Сторона_ — Обложка или Страница;
...
{% hint style="warning" %}
Необходимо создать сам шаблон в [редакторе](fotokalendar.md#redaktor): разместить на нем необходимые компоненты, которые клиент сможет использовать.
{% endhint %}
...
* [область шаблона](fotokalendar.md#oblast-shablona-komponenty);
* [компоненты](fotokalendar.md#komponenty);
* [слои](fotokalendar.md#sloi).
...
{% tab title="Месяц" %}
![Компонент "Месяц"](<../../.gitbook/assets/image (965).png>)

{% hint style="danger" %}
Для корректной работы конструктора фотокалендарей и его компонентов, необходимо настроить [Стили календарей](../stili-kalendarei.md)
{% endhint %}

Настройки компонента "Месяц".

![Настройки компонента "Месяц"](<../../.gitbook/assets/image (1261).png>)

В дополнительных настройках компонента можно выбрать тип месяца:

* _Стандартный_ — месят обозначается словом - Январь;

![Тип Стандартный](<../../.gitbook/assets/image (1930).png>)

* _Комбинированный_ — месяц обозначается двумя языками через символ "/" - Январь / January (обозначение месяца через "/" **всегда** на английском;

![Тип Комбинированный](<../../.gitbook/assets/image (3681).png>)

* _Цифровой_ — месяц обозначается цифрой - 01 (Январь).

![Тип Цифровой](<../../.gitbook/assets/image (3618).png>)

Язык, на котором будет отображаться месяц.\
Если выбран параметр "---", язык берется из [Стилей календарей](../stili-kalendarei.md).
...
{% tab title="Год" %}
![Компонент "Год"](<../../.gitbook/assets/image (1284).png>)
...
![Настройки компонента "Год"](<../../.gitbook/assets/image (1952).png>)
...
{% tab title="Месяц + Год" %}
![Компонент "Месяц + Год"](<../../.gitbook/assets/image (3670).png>)
...
![Настройки компонента "Месяц + Год"](<../../.gitbook/assets/image (1952).png>)

В дополнительных настройках компонента можно выбрать язык, на котором будет отображаться месяц.\
Если выбран параметр "---", язык берется из [Стилей календарей](../stili-kalendarei.md).
...
{% tab title="Сетка" %}
![Компонент "Сетка"](<../../.gitbook/assets/image (2529).png>)
...
{% hint style="danger" %}
Компонент "Сетка" настраивается в стилях в разделе [Стили календарей](../stili-kalendarei.md#setka)
{% endhint %}
{% endtab %}
{% endtabs %}
